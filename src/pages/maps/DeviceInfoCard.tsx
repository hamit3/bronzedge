                ...
                title={
                    <div style={{ padding: '12px 0' }}>
                        <Space direction="vertical" size={0}>
                            <Title level={4} style={{ margin: 0, color: "#fff", fontSize: '15px' }}>
                                {device.name || "Device Info"}
                            </Title>
                            <Space size={4}>
                                <Text style={{ fontSize: "10px", color: 'rgba(255,255,255,0.45)', fontFamily: 'monospace' }}>
                    ...
                    <Space direction="vertical" style={{ width: "100%" }} size="middle">
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <Badge
                                ...
                                text={<Text style={{ color: device.is_active ? '#52c41a' : 'rgba(255,255,255,0.45)', fontWeight: 600, fontSize: '11px' }}>{device.is_active ? "Active" : "Inactive"}</Text>}
                            />
                        ...
                        <div className="info-section">
                            <Text strong style={{ display: "block", marginBottom: "6px", color: 'rgba(255,255,255,0.85)', fontSize: '10px', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
                            ...
                            {lastMessage?.latitude ? (
                                <div style={{ background: 'rgba(255,255,255,0.03)', padding: '10px', borderRadius: '6px', border: '1px solid rgba(255,255,255,0.06)' }}>
                                    ...
                                    <Text style={{ fontSize: "10px", color: 'rgba(255,255,255,0.35)', display: 'block' }}>
                        ...
                        <div style={{ display: "flex", justifyContent: "space-between", gap: "12px" }}>
                            <div style={{ flex: 1, background: 'rgba(255,255,255,0.03)', padding: '8px', borderRadius: '6px', border: '1px solid rgba(255,255,255,0.06)' }}>
                                <Space size={4} style={{ marginBottom: "4px" }}>
                                    <SignalFilled style={{ color: '#1890ff', fontSize: '10px' }} />
                                    <Text style={{ fontSize: "10px", color: 'rgba(255,255,255,0.45)', fontWeight: 600 }}>SIG</Text>
                                </Space>
                                {rsrp !== null ? (
                                    <Text style={{ fontSize: "12px", color: '#fff', fontWeight: 500, display: 'block' }}>{rsrp} <small style={{ color: 'rgba(255,255,255,0.35)', fontSize: '9px' }}>dBm</small></Text>
                                ) : <Text style={{ color: 'rgba(255,255,255,0.25)', fontSize: '12px' }}>N/A</Text>}
                            </div>
                            <div style={{ flex: 1, background: 'rgba(255,255,255,0.03)', padding: '8px', borderRadius: '6px', border: '1px solid rgba(255,255,255,0.06)' }}>
                                <Space size={4} style={{ marginBottom: "4px" }}>
                                    <ThunderboltOutlined style={{ color: '#fadb14', fontSize: '10px' }} />
                                    <Text style={{ fontSize: "10px", color: 'rgba(255,255,255,0.45)', fontWeight: 600 }}>BAT</Text>
                                </Space>
                                {battery !== null ? (
                        ...
                        {chartData && chartData.length > 0 && (
                            <div className="chart-section">
                                <Text strong style={{ fontSize: "10px", display: "block", marginBottom: "8px", color: 'rgba(255,255,255,0.85)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
                                    Telemetry Trend
                                </Text>
                                <div style={{ height: 80, marginLeft: '-24px' }}>
